...
TEST_CASE("MemoryDumper", "[log]") {
  ...
  SECTION("colored output") {
    SECTION("packed members") {
      ...
      MemoryDumper::dump(
          v, 5, 16,
          {
              ...
              .count = 5,
              .color = ConsoleColors::combine(ConsoleColors::yellow,
                                              ConsoleColors::dim),
              .sub_regions =
                  {
                      // a
                      {offsetof(S, a),
                       ...
                       {}},
                      // b
                      {offsetof(S, b), sizeof(S::b), 1, ConsoleColors::red, {}},
                      // c
                      {offsetof(S, c),
                       sizeof(S::c),
                       1,
    ...
    SECTION("bad alignment") {
      ...
      MemoryDumper::dump(
          ...
          {0,
           ...
           {
               // a
               {offsetof(S, a), sizeof(S::a), 1, ConsoleColors::green, {}},
               // b
               {offsetof(S, b), sizeof(S::b), 1, ConsoleColors::red, {}},
               // c
               {offsetof(S, c), sizeof(S::c), 1, ConsoleColors::blue, {}},
           }},
          memory_dumper_options::colored_output |
              memory_dumper_options::cache_align);
    } //
    SECTION("array") {
      ...
      MemoryDumper::dump(
          a, 10, 8, {0, sizeof(int), 10, ConsoleColors::red, {}, DataType::I32},
    ...
    SECTION("member values") {
      ...
      MemoryDumper::RegionLayout layout = {0,
                                           sizeof(S),
                                           3,
                                           ConsoleColors::red,
                                           {
    ...
    SECTION("region construction") {
      MemoryDumper::RegionLayout layout =
          MemoryDumper::RegionLayout()
              ...
              .withSubRegion(MemoryDumper::RegionLayout().withSizeOf<u32>(4),
                             true);
